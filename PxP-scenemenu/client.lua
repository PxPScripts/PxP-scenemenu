  ...
  while true do
    ...
    elseif WarMenu.IsMenuOpened('speedzones') then
      ...
      elseif WarMenu.Button('Create Zone') then
        ...
        exports.bulletin:SendAdvanced("Du lavede en Trafik Zone", "Politi Zone", "Vigtig Information", "CHAR_CALL911")
        ...
        exports.bulletin:SendAdvanced("Besked sendt.", "Politi Zone", "Vigtig Information", "CHAR_CALL911")

      elseif WarMenu.Button('Delete Zone') then

        TriggerServerEvent('Disable')
        --ShowNotification("Disabled zones.")
        exports.bulletin:SendAdvanced("Du Slettede Trafik Zonen", "Politi Zone", "Vigtig Information", "CHAR_CALL911")
      ...
      if IsControlJustReleased(0, Config.ActivationKey) and GetLastInputMethod( 0 ) then
        ...
        if Config.UsageMode == "Ped" then
          ...
          if inArrayPed(pmodel, Config.WhitelistedPeds) then
            ...
            exports.bulletin:SendAdvanced("Du har ikke den rigtige PED Model på for dette", "Politi Zone", "Vigtig Information", "CHAR_CALL911")
          end
        elseif Config.UsageMode == "IP" then
          ...
          if inArray(GlobalData, Config.WhitelistedIPs) then
            ...
            exports.bulletin:SendAdvanced("Du har ikke tillaldse til dette", "Politi Zone", "Vigtig Information", "CHAR_CALL911")
          end
